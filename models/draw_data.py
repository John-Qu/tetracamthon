...
plt.plot(d, right_jaw_place, color="green", linewidth=3.0, linestyle="-", label="right york")
plt.plot(d, left_jaw_place, color="green", linewidth=1.0, linestyle="--", label="left york")
